...
function habilitarBotones() {
    ...
    const campoTelefono = document.getElementById("cel");
    const campoFechaNacimiento = document.getElementById("fn");
    const campoSexo = document.getElementById("sex");
    const campoSucursal = document.getElementById("suc_id");
    ...
    if (campoNombre.value == "") {
        ...
        campoSucursal.setAttribute("readonly", true); 
    }
...
function confirmarOperacion() {
    ...
    botonEditar.addEventListener("click", (event) => {
        mensaje = "¿Desea modificar los datos de este empleado?";
