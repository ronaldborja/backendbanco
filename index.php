    ...
    <section class="header">
            <ul class="nav">
                    ...
                    <li><a href="">EMPLEADOS</a>
                        <ul class="empleado">
                            <li><a href="../backendbanco/view/empleado/agregar.php">Añadir Empleado</a>
                    ...
                    <ul class="sucursal">
                            <li><a href="../backendbanco/view/sucursales/agregar.php">Añadir Sucursal</a>
                            <li><a href="../backendbanco/view/sucursales/buscar.php">Buscar Sucursal</a>
                            <li><a href="../backendbanco/view/sucursales/buscar.php">Actualizar Sucursal</a>
                            <li><a href="../backendbanco/view/sucursales/buscar.php">Eliminar Sucursal</a>
                            <li><a href="../backendbanco/view/sucursales/listar_todo.php">Listar Sucursales</a>
                        </ul>
                    </li>
